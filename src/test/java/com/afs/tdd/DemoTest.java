...
class DemoTest {
    ...
    @Test
    void should_return_locationX_0_locationY_0_direction_N_when_execute_command_given_locationX_0_locationY_0_direction_E_action_L(){
        //given
        Application currentMarsRover = new Application(new RoverStatus(0, 0, "E"));
        RoverStatus expectedMarsRover = new RoverStatus(0, 0 ,"N");
    ...
    @Test
    void should_return_locationX_0_locationY_0_direction_S_when_execute_command_given_locationX_0_locationY_0_direction_W_action_L(){
        //given
        Application currentMarsRover = new Application(new RoverStatus(0, 0, "W"));
        RoverStatus expectedMarsRover = new RoverStatus(0, 0 ,"S");
    ...
    @Test
    void should_return_locationX_0_locationY_0_direction_E_when_execute_command_given_locationX_0_locationY_0_direction_N_action_R(){
        //given
        Application currentMarsRover = new Application(new RoverStatus(0, 0, "N"));
        RoverStatus expectedMarsRover = new RoverStatus(0, 0 ,"E");

        //when
        currentMarsRover.executeCommand("R");
    ...
    @Test
    void should_return_locationX_0_locationY_0_direction_W_when_execute_command_given_locationX_0_locationY_0_direction_S_action_R(){
        //given
        Application currentMarsRover = new Application(new RoverStatus(0, 0, "S"));
        RoverStatus expectedMarsRover = new RoverStatus(0, 0 ,"W");
    ...
    @Test
    void should_return_locationX_0_locationY_0_direction_S_when_execute_command_given_locationX_0_locationY_0_direction_E_action_R(){
        //given
        Application currentMarsRover = new Application(new RoverStatus(0, 0, "E"));
        RoverStatus expectedMarsRover = new RoverStatus(0, 0 ,"S");
    ...
    @Test
    void should_return_locationX_0_locationY_0_direction_N_when_execute_command_given_locationX_0_locationY_0_direction_W_action_R(){
        //given
        Application currentMarsRover = new Application(new RoverStatus(0, 0, "W"));
        RoverStatus expectedMarsRover = new RoverStatus(0, 0 ,"N");
